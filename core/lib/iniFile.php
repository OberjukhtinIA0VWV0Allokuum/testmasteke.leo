...
/**
   ...
   */ 
   ...
   class iniFile{
      ...
      const WRONG_EXT =  'error::::1::::не *.ini';
      const NOT_FOUND =  'error::::2::::Указанный файл не найден';
      const WRONG_READ = 'error::::3::::Не возможно прочитать указанный файл';
      const ERROR_SAVE = 'error::::4::::Не могу сохранить файл';
      /**
   ...
   /**
        * Метод изменяет имя файла, с которм работаем
        @param string Путь/имя_файла
        * @return bool
        */
     public function NewFile($path_to_ini_file){
         $this->ini_file = $path_to_ini_file;        
